...
else if year in (2010 2011 2012 2013 2014 2015 2016 2017
2018 2019 2020 2021 2024) then wt_adj = wt_itvex * (192 / 2996);

if 19 <= age < 40 then age_g = 1;
else if 40 <= age <65 then age_g = 2;
else if age >= 65 then age_g = 3;
else if age < 19 then age_g = 8;
...
if (BS1_1 in (1 3)) or (BS1_1 = 2 and BS3_1 = 3) then smoking_g = 0;
else if BS1_1 = 2 and BS3_1 in (1,2) then smoking_g = 1;
else if BS1_1 in (8 9) or BS3_1 in (8,9) then smoking_g = 8;
run;
...
else if HE_prg = 1 then prg_g = 8;

if HE_fst >= 8 then fst_g = 0;
else if HE_fst < 8 then fst_g = 8;
run;

data dd; set dd;
if DI1_dg in (0 8) then hypertension_g = 0;
else if DI1_dg = 1 then hypertension_g = 1;
else if DI1_dg = 9 then hypertension_g = 8;

if DI2_dg in (0 8) then dyslipidemia_g = 0;
else if DI2_dg = 1 then dyslipidemia_g = 1;
else if DI2_dg = 9 then dyslipidemia_g = 8;

if DI3_dg in (0 8) then stroke_g = 0;
else if DI3_dg = 1 then stroke_g = 1;
else if DI3_dg = 9 then stroke_g = 8;

if DI5_dg in (0 8) then mi_g = 0;
else if DI5_dg = 1 then mi_g = 1;
else if DI5_dg = 9 then mi_g = 8;

if DI6_dg in (0 8) then angina_g = 0;
else if DI6_dg = 1 then angina_g = 1;
else if DI6_dg = 9 then angina_g = 8;
run;

data dd; set dd;
if age_g = 8 or educ_g = 8 or marri_g = 8 or health_g = 8 or
stress_g = 8 or drinking_g = 8 or smoking_g = 8 or prg_g = 8 or fst_g = 8
or hypertension_g = 8 or dyslipidemia_g = 8
or stroke_g = 8 or mi_g = 8 or angina_g = 8
then subject = 0;
else subject = 1;
run;
